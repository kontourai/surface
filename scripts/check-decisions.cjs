...
// updated to this repo's vendored copy path) for surface's ADR
// freeze-and-index rollout, following the kontourai/traverse pilot (PR #17)
// per https://github.com/kontourai/flow-agents/issues/314. Do not hand-edit the
