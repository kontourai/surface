...
export function validateTrustInput(input: unknown): TrustInput {
  ...
  for (const item of evidence) {
    ...
    for (const field of ["id", "claimId", "evidenceType", "sourceRef", "excerptOrSummary", "observedAt", "collectedBy"]) {
  ...
  return { source, claims, evidence, policies, events } as TrustInput;
}
