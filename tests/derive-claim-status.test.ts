 ...
 *
 * Loads the standard fixture, runs buildTrustReport, then for each claim in
...
test("deriveClaimStatus matches buildTrustReport per-claim status for all fixture claims", async () => {
