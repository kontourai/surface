...
test("builds a canonical trust report from the validation example bundle", async () => {
  ...
  // buildTrustReport always emits the CURRENT schemaVersion (5) — Hachure
  // facet rename, item "emission side" mandate — regardless of the input
  // bundle's own self-declared schemaVersion (this fixture is schemaVersion 3,
  // read through validateTrustBundle's legacy-facet read-tolerance shim).
