...
AI makes plausible output cheap and lets polished product claims move faster than human review. Decisions still need traceable evidence, freshness, authority, integrity, and visible conflict state. Surface keeps that structure inspectable instead of burying it inside a prompt, a generic console, or a single confidence score. See [Concepts](docs/product/concepts.md) for the full vocabulary.
...
- [CLI](docs/reference/cli.md) — shipped report and claim commands
- [Schemas](docs/reference/schemas.md) — claim, evidence, policy, event, and report contracts
- [Use Cases](docs/product/use-cases.md) — where Surface fits
...
- [Repo Hooks](docs/maintenance/repo-hooks.md) — local contributor hook setup and validation
