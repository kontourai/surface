...
![The surface-trust-panel element rendering the example report: status chips, expandable claims, evidence, and policy context](../../assets/screenshots/trust-panel.png)
